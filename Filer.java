...
public class Filer {
	...
	public Laerer opprettLaerer(Scanner leser) {
		...
		lr.setFodselsNr(Long.parseLong(leser.nextLine()));
		lr.setEtternavn(leser.nextLine());
		lr.setFornavn(leser.nextLine());
		lr.setmLonn(Integer.parseInt(leser.nextLine()));
		lr.setKontornummer(Integer.parseInt(leser.nextLine()));
		return lr;
	}
